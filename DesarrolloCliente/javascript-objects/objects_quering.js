...
console.log(`Valor vacío: ${empty.valor}`);
console.log(`Valor vacío: ${point.x} <-- este valor debería ser 0`);
console.log(`Valor vacío: ${point2.y} <-- este valor debería ser 1`);

point.x = 10;
point.y = 20;

// Change book meta data.
book['main title'] = 'title test';
book['sub-title'] = 'subtitle test';
book['for'] = 'for test';
console.log(book);

// Change author data.
book.author['firstname'] = 'Toni'; 
book.author['surname'] = 'Ramon';
console.log(`Mostramos el autor: ${book.author}`);
