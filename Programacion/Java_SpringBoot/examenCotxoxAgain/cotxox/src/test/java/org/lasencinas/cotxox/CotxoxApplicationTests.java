...
import org.lasencinas.cotxox.service.CarreraService;
import org.lasencinas.cotxox.service.ConductorService;
...
public class CotxoxApplicationTests {
	...
	public void test_save_conductor() {
		...
		for(int i = 0; i < nombres.length; i++) {
			conductorService.crearConductor(tarjetas[i], nombres[i], matricula[i], modelos[i]);
		}
